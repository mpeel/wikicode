...
for prefix in wikipedias:
	...
	for option in range(0,1):
		...
		if option == 0:
			...
			pages = parsequarry('quarry-51950-enwp-categories-without-wikidata-run526533.csv')
		else:
