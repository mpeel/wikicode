...
langs = 'en-ca,en-gb,de,fr,es,pt,nl,it,sv,af,an,bar,bm,br,ca,co,cy,da,de-at,de-ch,eo,et,eu,fi,frc,frp,fur,ga,gd,gl,gsw,hr,ia,id,ie,io,jam,kab,kg,lb,li,lij,lt,mg,mi,nap,nb,nds,nds-nl,nn,nrm,min,ms,oc,pap,pcd,pms,prg,pt-br,rgn,rm,ro,sc,scn,sco,sk,sl,sq,sr-el,sw,tr,vec,vi,vls,vmf,vo,wa,wo,zu'
langs_exclude = 'en,ru'
# Q159 = Russia, Q15180 = Soviet Union, Q17=Japan, Q28=Hungary
...
for i in range(0,numsteps):
	...
	for page in generator:
		...
		if label != '':
			...
			if test == 'y':
				try:
					page.editLabels(labels={'en': label}, summary=u'Copy ' + labellang + ' label to en label "' + label + '"',minorEdit=True)
					nummodified += 1
				except:
					print('Edit failed')
