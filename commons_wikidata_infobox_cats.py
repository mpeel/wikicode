...
targetcats = ['Category:Female sportspeople by country by sport','Category:Male sportspeople by country by sport','Category:World War memorials in Germany','Category:Men of Germany by name','Category:Men of Austria by name','Category:Women of Austria by name','Category:Women of Germany by name','Category:Musical groups from Austria','Category:Musical groups from Germany','Category:Streets in Munich by name','Category:Streets in Vienna by name','Category:Cultural heritage monuments in Brandenburg with known ID','Category:Churches in Germany']
