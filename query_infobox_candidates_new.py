...
with conn.cursor() as cur:
	...
	" AND ("\
	"	SELECT cl1.cl_from"\
	"	FROM categorylinks AS cl1 join linktarget cllt on cllt.lt_namespace = 15 and cllt.lt_id = cl1.cl_target_id WHERE cllt.lt_title = 'Category_redirects'  AND cl_type = 'subcat'"\
